...
_C.DATASET.ROOT = ""
_C.DATASET.NAME = ""
# Relative paths for train/test splits (if applicable)
...
# Whether to resume from checkpoint if exists in output directory
# Set to False to always start training from scratch
